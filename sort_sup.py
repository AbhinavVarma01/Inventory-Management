...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        ...
        <select id="sort" name="sort" style="margin-left: 10px; padding: 5px; border: 1px solid #800000;">
            ...
            <option value="phoneno3">phoneno3</option>
            <option value="phoneno3">blacklisted</option>
...
print("<th class='nav__title'>sname</th>")
...
print("<th class='nav__title'>phoneno1</th>")
print("<th class='nav__title'>phoneno2</th>")
print("<th class='nav__title'>phoneno3</th>")
...
if "action" in form:
    ...
    if action == "Display":
        ...
        cursor.execute("SELECT * FROM suppliers WHERE supid LIKE ? OR sname LIKE ? OR area LIKE ? OR locality LIKE ?", 
        ...
        cursor.execute(f"SELECT * FROM suppliers ORDER BY {sort_query}")
        employees = cursor.fetchall()
        for employee in employees:
            print("<tr>")
            for field in employee:
