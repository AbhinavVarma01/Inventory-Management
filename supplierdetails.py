...
def get_suppliers(itemname):
    cursor.execute("SELECT * FROM suppliers WHERE supid IN (SELECT supplierid FROM itemtable WHERE itemname=?)", (itemname,))
...
print("<h1>Supplier Details</h1>")
print("<form id='supplierForm' method='post'>")
print("<label for='itemname'>Select Item name:</label>")
print(generate_dropdown())
print("<button type='submit'>Display Suppliers</button>")
print("</form>")
print("<div id='supplierTable'>")
if suppliers:
    print("<table>")
    print("<tr><th>Supplier ID</th><th>Name</th><th>Area</th><th>Locality</th><th>Pincode</th><th>Email</th><th>Phone 1</th><th>Phone 2</th><th>Phone 3</th><th>Blacklisted</th></tr>")
