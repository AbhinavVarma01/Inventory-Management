...
<body>
    <div class="header-container">
        <div class="logo-column">
            <img src="college_logo.jpg" class="logo">
        </div>
...
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>  Item History :-</h1>")
...
print("<tr>")
print("<th class='nav__title'>Receipt Voucher Number</th>")
print("<th class='nav__title'>Item ID</th>")
print("<th class='nav__title'>Item Name</th>")
print("<th class='nav__title'>Quantity</th>")
print("<th class='nav__title'>Amount</th>")
print("<th class='nav__title'>Payment Date</th>")
print("<th class='nav__title'>Mode Of Payment</th>")
print("<th class='nav__title'>Recieved By Employee ID</th>")
